...
function App() {
  return (
    <div className="h-screen w-screen relative overflow-hidden bg-slate-900 flex flex-col items-center justify-center">
      ...
      <Boxes />
      <h1 className={cn("md:text-4xl text-xl text-white z-20")}>
        Under Construction
      </h1>
      <a
        href="https://github.com/Serikuly-Miras"
        className="md:text-lg text-sm text-white z-20 mt-4 hover:underline"
        target="_blank"
